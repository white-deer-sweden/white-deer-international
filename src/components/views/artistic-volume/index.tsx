...
import ImgB6 from '$/static/B 6.jpg';
  ...
  return (
    <Container className="mt-32">
      <div className="grid grid-cols-12 gap-[74px] lg:gap-12 sm:grid-cols-1 sm:gap-6">
        ...
        <div className="col-span-7 py-14 sm:col-span-full sm:row-start-1 sm:py-0 tablet:pb-0">
          ...
          <p className="mt-3 text-sm font-500 leading-snug text-[#989898] sm:text-sm">
            ...
            and
            <br className="lg:hidden" /> Captivating Designs.
          </p>
            ...
            <ul className="space-y-4 text-white">
              {artisticVolumes.map((av) => (
                <li
                  ...
                  className={cn(
                    'flex h-[72px] cursor-pointer items-center gap-2 rounded-3xl bg-[#0D0D0D] px-8 py-6 text-xl font-500 text-[#5C5C5C] transition duration-500 sm:text-sm tablet:h-14 tablet:rounded-xl tablet:px-4 tablet:py-2 tablet:text-base',
                    {
